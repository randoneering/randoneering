...
- [usekaneo/kaneo](https://github.com/usekaneo/kaneo) - 🎯 All you need. Nothing you don&#39;t. Open source project management that works for you, not against you. (4 weeks ago)
...
- [sigstore/sigstore-python](https://github.com/sigstore/sigstore-python) - A Sigstore client written in Python (1 week ago)
- [sigstore/rekor](https://github.com/sigstore/rekor) - Software Supply Chain Transparency Log (1 week ago)
- [sigstore/fulcio](https://github.com/sigstore/fulcio) - Sigstore OIDC PKI (1 week ago)
- [sigstore/cosign](https://github.com/sigstore/cosign) - Code signing and transparency for containers and binaries (1 week ago)
- [ossf/DevRel-community](https://github.com/ossf/DevRel-community) - Evangelizing the mission and work of the OpenSSF and building strong community outreach around end-users, open-source maintainers, and contributors. (1 week ago)
...
- [update function, view, high tests, and readme](https://github.com/randoneering/pgFirstAid/pull/28) on [randoneering/pgFirstAid](https://github.com/randoneering/pgFirstAid) (3 days ago)
...
- [fix: upgrade nginx 1.25 to 1.29.5 to reduce vulnerabilities ](https://github.com/usekaneo/kaneo/pull/930) on [usekaneo/kaneo](https://github.com/usekaneo/kaneo) (4 weeks ago)
- [[Snyk] Security upgrade nginx from 1.25-alpine to 1.29.5-alpine](https://github.com/randoneering/kaneo/pull/1) on [randoneering/kaneo](https://github.com/randoneering/kaneo) (4 weeks ago)
